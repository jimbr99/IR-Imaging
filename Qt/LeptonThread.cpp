...
#if HAVE_LEPTON // true //HAVE_LEPTON
const char *LeptonThread::device = "/dev/spidev1.0"; // Change to 0.1 if required
...
#if !HAVE_LEPTON
        usleep(100000);  // Need to slow things down if no ioctl call!
